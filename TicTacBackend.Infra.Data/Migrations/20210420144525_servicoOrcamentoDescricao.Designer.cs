...
namespace TicTacBackend.Infra.Data.Migrations
{
    ...
    [Migration("20210420144525_servicoOrcamentoDescricao")]
    partial class servicoOrcamentoDescricao
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TicTacBackend.Domain.Entities.Servicos.ServicoOrcamentoDescricao", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("ServicoOrcamentoDescricao");
                });
            ...
            modelBuilder.Entity("TicTacBackend.Domain.Entities.Servicos.ServicoOrcamentoDescricao", b =>
                {
                    ...
                    b.HasOne("TicTacBackend.Domain.Entities.Servicos.Servico", "Servico")
                        .WithMany()
                        .HasForeignKey("ServicoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
